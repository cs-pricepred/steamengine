        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-display rounded-md text-stone-500 dark:text-stone-400 bg-white dark:bg-stone-800 hover:text-stone-700 dark:hover:text-stone-300 focus:outline-none transition ease-in-out duration-150">
